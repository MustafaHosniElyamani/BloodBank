...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body"><a href="{{ url(route('user.create')) }}" class="btn btn-primary "> <i
                            ...
                            <tbody>
                                ...
                                @foreach ($records as $record)
                                    <tr>
                                        ...
                                        <td>{{ $record->name }}</td>
                                        <td>{{ $record->email }}</td>
                                        {{-- <td>@foreach ($record->roles as $role)
                                                    {{ $role->name }}
                                                @endforeach</td> --}}
                                         <td>{{$record->getRoleNames()->implode(',');}}</td>
                                        <td><a href="{{ url(route('user.edit', $record->id)) }}"
