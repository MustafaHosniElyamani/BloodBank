...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body"><a href="{{ url(route('city.create')) }}" class="btn btn-primary "> <i
                                ...
                                @foreach ($records as $record)
                                    <tr>
                                        ...
                                        <td>{{ $record->governorate->name }}</td>
                                         ...
                                         {{-- <td>{{ $governorate->firstWhere('id', $record->governorate_id)->name }}</td> --}}
                                        <td><a href="{{ url(route('city.edit', $record->id)) }}"
                                        ...
                                        <td>
                                            ...
                                            {!! Form::close() !!} --}}
                                            {!! Form::open([
                                                'action' => ['App\Http\Controllers\CityController@destroy',$record->id],
                                                  'method' => 'delete'
                                            ]) !!}
                                            {!! Form::token() !!}
                                            <button type="submit" class="btn btn-danger "> <i class="fa fa-trash"></i></button>
